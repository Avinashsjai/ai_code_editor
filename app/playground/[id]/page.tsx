                        ...
                        <div className='flex flex-1 items-center gap-2'>
                            ...
                            <div className='flex items-center gap-1'>
                                ...
                                <Tooltip>
                                    ...
                                    <TooltipContent>Save All (Ctrl+Shift+5)</TooltipContent>
                                </Tooltip>
                    ...
                    <div className='h-[calc(100vh-4rem)]'>
                        {
                            openFiles.length > 0 ? (
                                        ...
                                        <Tabs
                                            ...
                                            <div className='flex items-center justify-between px-4 py-2'>
                                                <TabsList className='h-8 bg-transparent p-0'>
                                                    {
                                                        openFiles.map((file) => (
                                                            <TabsTrigger key={file.id} value={file.id} className='relative h-8 px-3 date-[state=active]:bg-background data-
                                                    [state=active]:shadow-sm group '>
                                                                ...
                                                                <div className='flex items-center gap-2'>
                                                                    ...
                                                                    <span
                                                                        className='ml-2 h-4 w-4 hover:bg-destructive hover:text-destructive-foreground rounded-sm
                                ...
                                <div className='flex flex-cal h-full items-center justify-center text-muted-foreground gap-4'>
                                    <FileText className='size-16 text-gray-300' />
                                    <div className='text-center'>
                                        <p className='text-lg font-medium'>No Files Open</p>
                                        <p className='text-sm text-gray-500'>
                                            Select a file from the sidbar to start editing
                                        </p>
                                    </div>
                                </div>
                            )
