        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button
                    ...
                    className={cn("relative gap-2 h-8 px-3 text-sm font-medium transition-all duration-200",
                        isEnabled ? "bg-zinc-900 hover:bg-zinc-800 txet-zinc-50 border-zinc-800 dark:bg-zinc-50 dark:hover:bg-zinc-200 dark:text-zinc-900 dark:border-zinc-200"
                            : "bg-background hover:bg-accent text-foreground border-border", suggestionLoading && "opacity-75")}
                    ...
                    <span>AI</span>
                    {
                        isEnabled ? (<div className='w-2 h-2 bg-green-500 rounded-full animate-pulse' />
                        ) : (
                ...
                <DropdownMenuLabel className='flex items-center justify-between py-2'>
                    ...
                    <Badge
                        ...
                        className={cn(
                            "text-xs",
                            isEnabled
                                ? "bg-zinc-900 text-zinc-50 border-zinc-800 dark:bg-zinc-50 dark:text-zinc-900 dark:boder-zinc-200"
